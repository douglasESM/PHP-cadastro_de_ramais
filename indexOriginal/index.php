...
   <input type="text" class="form-control" name="consultorio" id="consultorio" required>
 </div>
 
 <div class="form-group col-md-3">
   <label>Setor</label>
...
    <textarea type="text" class="form-control" name="obs" placeholder="Escreva sua mensagem" id="obs" rows="5" required></textarea>
 </div>
 
...
   <input type="text" class="form-control" name="cel02" id="celular" placeholder="(__)____-____">
 </div>
 </div>
...
      <a href="index.html" class="btn btn-default">Cancelar</a>
  ...
  <!-- Formulário busca -->
		...
		<div id="main" class="container-fluid">
		<h3 class="page-header">Pesquisar</h3>
